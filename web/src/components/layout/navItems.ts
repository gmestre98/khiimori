...
// TRIP_TAB_ICON is the suitcase icon used by the sidebar's dynamic "Trip · …"
// switcher tab (rendered separately from the plain nav items).
export const TRIP_TAB_ICON = ICONS.trip
