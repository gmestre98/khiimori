...
// server drops any location it can't resolve, so we only trust the positional
// pairing when every location came back — an equal length guarantees each
// waypoint belongs to the location at the same index. Best-effort and fire-and-
// forget.
