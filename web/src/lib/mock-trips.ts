...
export const mockTripsResponse: TripsResponse = {
  ...
  past: [
    {
      id: 'mock-past-vietnam',
      owner_id: 'mock-user',
      name: 'Vietnam Loop',
      destinations: ['Hanoi', 'Hội An', 'Da Nang'],
      start_date: isoDay(-120),
      end_date: isoDay(-106),
      base_currency: 'EUR',
      cover: '',
    ...
    {
      id: 'mock-past-california',
      owner_id: 'mock-user',
      name: 'California Coast',
      destinations: ['San Francisco', 'Big Sur', 'Los Angeles'],
      start_date: isoDay(-720),
      end_date: isoDay(-710),
      base_currency: 'EUR',
      cover: '',
    ...
    {
      id: 'mock-past-scotland',
      owner_id: 'mock-user',
      name: 'Scotland Highlands',
      destinations: ['Edinburgh', 'Isle of Skye'],
      start_date: isoDay(-800),
      end_date: isoDay(-793),
      base_currency: 'EUR',
      cover: '',
      continent: 'europe',
