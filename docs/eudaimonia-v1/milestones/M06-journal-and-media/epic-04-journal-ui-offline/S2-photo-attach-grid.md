...
## Acceptance criteria
- [ ] Users can attach photos to the day's entry (Epic 02 upload) and add optional **captions**.
- [ ] The grid/list renders **thumbnail variants** (Epic 03 S3), not originals; opening a photo can load a
  larger version on demand.
- [ ] Upload progress and failures (including cap rejection, S3) are surfaced.
- [ ] The grid is responsive and photo-forward (photos are the visual content, PRD §5.10).
