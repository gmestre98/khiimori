...
| [12](M12-plan-redesign/README.md) | Plan redesign | Rework the day planner: typed items (activity/transport/food/note) decoupled from budget category, single pinned stays, one drag-ordered timeline | **✅ Epic 01 done** | §5.2, §9, §7.0 |
